...
async function checkWeather(city){
    ...
    for(i=0;i<41;i++){
        if(new Date(data5days.list[i].dt*1000).getDay() !== new Date(previousDate).getDay()){
            ...
            document.getElementById("temp"+x).innerHTML=Math.round(Math.min(data5days.list[i].main.feels_like,data5days.list[i].main.feels_like,data5days.list[i].main.temp,data5days.list[i].main.temp_min,data5days.list[i].main.temp_max))+"°C / "+Math.round(Math.max(data5days.list[i].main.feels_like,data5days.list[i].main.feels_like,data5days.list[i].main.temp,data5days.list[i].main.temp_min,data5days.list[i].main.temp_max))+"°C";
